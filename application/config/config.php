...
|
*/
$config['base_url'] = 'http://192.168.0.13/ged';
...
#$config['header_js']  = array('jquery.js','bootstrap.min.js', 'ripples.min.js',
#        'material.js', 'jquery.dropdown.js', 'angular.js', 'jquery.inputmask.js', 'script.js');
